    ...
    return (
        <div>
            ...
            >
                ...
                <center>
                    <Carousel responsive={responsive} className="car-1">
                        <div><img className="car-img-modal" src={`http://127.0.0.1:8000${card.thumbnail}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`http://127.0.0.1:8000${card.img1}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`http://127.0.0.1:8000${card.img2}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`http://127.0.0.1:8000${card.img3}`} alt="slide" /></div>
                    </Carousel>
                </center>
                <Container>
                    <Modal.Body>
