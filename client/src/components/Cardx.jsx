    ...
    return (
        <div>
            ...
            <Col lg={12}>
                <Card className="car-1">
                    ...
                    <Carousel responsive={responsive} className="car-1">
                        <div><img className="car-img" src={`https://aclassdoon.herokuapp.com${card.thumbnail}`} alt="slide" /></div>
                        <div><img className="car-img" src={`https://aclassdoon.herokuapp.com${card.img1}`} alt="slide" /></div>
                        <div><img className="car-img" src={`https://aclassdoon.herokuapp.com${card.img2}`} alt="slide" /></div>
            ...
            >
                ...
                <center>
                    <Carousel responsive={responsive} className="car-1">
                        <div><img className="car-img-modal" src={`https://aclassdoon.herokuapp.com${card.thumbnail}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`https://aclassdoon.herokuapp.com${card.img1}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`https://aclassdoon.herokuapp.com${card.img2}`} alt="slide" /></div>
                        <div><img className="car-img-modal" src={`https://aclassdoon.herokuapp.com${card.img3}`} alt="slide" /></div>
                    </Carousel>
                </center>
                <Container>
                    <Modal.Body>
